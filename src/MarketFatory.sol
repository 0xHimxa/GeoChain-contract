...
contract MarketFactory is Ownable {
    ...
    function createMarket(
        ...
        PredictionMarket m = new PredictionMarket(
            question, address(collateral), closeTime, resolutionTime, feeBps, initialLiquidity, msg.sender
        );

        // transfer USDC to market
        require(collateral.transferFrom(msg.sender, address(m), initialLiquidity), "USDC transfer failed");
