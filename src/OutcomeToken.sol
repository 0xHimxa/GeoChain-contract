...
contract OutcomeToken is ERC20 {
    ...
    /// @notice Address of the prediction market that controls this token
    ...
    /**
     * @notice Ensures only the market contract can call mint/burn functions
     * @dev Critical security control to prevent unauthorized token creation/destruction
     */
    modifier onlyMarket() {
        if (msg.sender != market) revert OutcomeToken__OnlyMarket();
        _;
    }
