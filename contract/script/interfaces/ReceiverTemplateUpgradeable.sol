...
/// @title ReceiverTemplateUpgradeable - Upgradeable receiver with optional permission controls
/// @notice Upgrade-safe version of ReceiverTemplate for proxy deployments
abstract contract ReceiverTemplateUpgradeable is Initializable, IReceiver, OwnableUpgradeable {
    // Required permission field at initialization, configurable after
